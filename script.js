...
function startWorkWeb() {
    project1 = { Name: "Slidle", Image: "/img/Github.png", Description: "Slider Puzzle, participated in the Peanut Jam 2022 hosted by TechCodes, Won the Award of Most Friendly UI.", Link: "https://github.com/kalongn/PeanutJam2022"};
    project2 = { Name: "SBU Weather Bot", Image: "/img/Linkedin.png", Description: "A discord command control weather bot that report weather using weather.js, node.js and discord.js.", Link: "https://github.com/kalongn/SBU-Weather-BOT"};

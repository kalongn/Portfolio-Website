...
function startWorkWeb() {
    project1 = { Name: "Slidle", Image: "/img/Github.png", Description: "Slider Puzzle, participated in the Peanut Jam 2022 hosted by TechCodes, Won the Award of Most Friendly UI."};
    project2 = { Name: "SBU Weather Bot", Image: "/img/Linkedin.png", Description: "A discord command control weather bot that report weather using weather.js, node.js and discord.js."};
    project3 = { Name: "Portfolio Website", Image: "/img/KLS_2023.png", Description: "A Website where I showcase my journey along the way as a prospect software engineer."};
